...
class MAGBaseProjectsGenerator: NSObject
{
  ...
  func baseProjects()
  {
    ...
    viewModel.addProject(name: "Test 1",
                         ...
                         sigma3dPath: "",
                         profilePath: "",
                         bxFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: ["v3.t1.txt", "v3.t2.txt"]),
                         byFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         bzFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         jxFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         jyFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         jzFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         isLocal: true)
    viewModel.addProject(name: "Test 2",
                         ...
                         sigma3dPath: "",
                         profilePath: "",
                         bxFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         byFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         bzFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         jxFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
                         jyFilePathsArray: NSKeyedArchiver.archivedData(withRootObject: [""]),
